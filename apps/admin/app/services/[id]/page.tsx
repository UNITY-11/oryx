...
export default function ServiceDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const original = MOCK_SERVICES.find((s) => s.id === id) ?? null;
              ...
              <div className="bg-primary/5 rounded-2xl p-4 space-y-3">
                <div className="flex items-center justify-between text-sm">
                  ...
                  <div className="flex items-center gap-1">
                    <input type="number" value={service.preparationTime} onChange={(e) => update("preparationTime", Number(e.target.value))} className="w-14 text-right bg-transparent text-primary-dark font-medium text-sm focus:outline-none" />
                ...
                <div className="flex items-center justify-between text-sm">
                  ...
                  <div className="flex items-center gap-1">
                    <input type="number" value={service.cleanupTime} onChange={(e) => update("cleanupTime", Number(e.target.value))} className="w-14 text-right bg-transparent text-primary-dark font-medium text-sm focus:outline-none" />
                    <span className="text-text-secondary text-xs">min</span>
                  </div>
                </div>
                <div className="flex items-center justify-between text-sm">
                  ...
                  <div className="flex items-center gap-1">
                    <input type="number" value={service.maxCapacity} onChange={(e) => update("maxCapacity", Number(e.target.value))} className="w-14 text-right bg-transparent text-primary-dark font-medium text-sm focus:outline-none" />

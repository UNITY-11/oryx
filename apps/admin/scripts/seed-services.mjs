...
const MOCK_SERVICES = [
  ...
  },
  {
    ...
    addons: [{ id: "a-6", name: "Herbal Compress", price: 45, duration: 15 }],
    preparationTime: 20,
    cleanupTime: 20,
    maxCapacity: 1,
  ...
  },
  {
    ...
    image: null,
    pricingTiers: [{ id: "pt-10", label: "Full Day (5-6 hrs)", price: 580, duration: 360 }],
    addons: [
  ...
  },
  {
    ...
    addons: [{ id: "a-11", name: "Cupping Therapy", price: 55, duration: 20 }],
    preparationTime: 10,
    cleanupTime: 15,
    maxCapacity: 1,
...
async function seed() {
  ...
  for (const service of MOCK_SERVICES) {
    transaction.createOrReplace({
      ...
      image: service.image,
      pricingTiers: withKeys(service.pricingTiers),
      addons: withKeys(service.addons),

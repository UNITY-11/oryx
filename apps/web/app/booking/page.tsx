...
export default function BookingPage() {
  return (
    <div className="absolute inset-0 md:relative md:inset-auto z-10 flex-1 flex flex-col md:items-center md:justify-center bg-[#fcf4f0] md:p-8 md:pt-32 overflow-hidden min-h-0">

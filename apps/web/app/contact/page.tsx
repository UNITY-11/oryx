import { Phone, Mail, MapPin, MessageCircle, Navigation, Twitter, Facebook, Instagram, Linkedin } from "lucide-react";

export default function ContactPage() {
  return (
    <div className="min-h-screen bg-surface pb-32">
      {/* Header */}
      <div className="pt-12 px-6 pb-6 bg-white/50 backdrop-blur-md sticky top-0 z-10 border-b border-primary/10">
